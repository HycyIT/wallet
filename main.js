...
const deleteTransaction = id => {
	...
	const tansactionAmount = parseFloat(transactionToDelete.childNodes[3].innerText)
	const indexOfTransaction = moneyArr.indexOf(tansactionAmount)
...
btnDark.addEventListener('click', changeStyleTodark)
btnLight.addEventListener('click', changeStyleToLight)
